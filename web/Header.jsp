...
<html>
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Indie+Flower|Kaushan+Script|Pacifico" rel="stylesheet">
    ...
    <body>
        ...
        <div class="agileits_header fixed">
            <div class="w3l_offers">
                ...
                <a href="Home.jsp">
                    <p class = "brand">Shoppy</p>
                </a>

            </div>
            <div class="w3l_search">
                <form action="Search.jsp" method="GET">
                    <input type="text" placeholder="Search a product..." name="productName" value="Search a product..." onfocus="this.value = '';" onblur="if (this.value == '') {
                            }" required="">
            ...
            <c:if test="${(empty user)}">
                <div class="w3l_header_right" style="color:white;display:inline-block;">
                    <a href="SignIn.jsp"  style="color:white;display:inline-block;">Login </a><i>  /  </i>
                    <a href="SignUp.jsp"  style="color:white;display:inline-block;">Sign Up</a>             
                </div>
            </c:if> 
            ...
            <c:if test="${!empty user }">
                ...
                <c:if test="${(user.type eq 'admin')}">
                    <div class="product_list_header" >   
                        <form action="Users.jsp" method="POST" class="last">
                            <input type="submit" name="submit" value="Manage Users" class="button" >
                        </form>
                    </div>
                </c:if>
                <%--//Display user img  --%>
                <div class="w3l_header_right" style="color:white;display:inline-block;">
                    ...
                    <a href="Profile.jsp">
                        <img style="width:30px; height:30px;display:inline-block;" src="GetImage?idU=getpp" alt=" " class="img-responsive">
                    </a>

                    <P style="display:inline-block;">${user.firstName}     </p>
                    <a href="LogoutServlet"  style="color:lightblue;display:inline-block;">Sign Out </a>
                </div>
            </c:if>
