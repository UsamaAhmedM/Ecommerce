            ...
            <nav class="navbar nav_bottom">
                ...
                <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                    <ul class="nav navbar-nav nav_1">
                        <li><a href="HomeCategory.jsp?category=FOOD">FOOD</a></li>
                        <li><a href="HomeCategory.jsp?category=CLOTHES">CLOTHES</a></li>
                        <li><a href="HomeCategory.jsp?category=DRINKS">DRINKS</a></li>
                        <li><a href="HomeCategory.jsp?category=ELECTRONICS">ELECTRONICS</a></li>
                        <li><a href="HomeCategory.jsp?category=FURNITURE">FURNITURE</a></li>
                        <li><a href="HomeCategory.jsp?category=STATIONARY">STATIONARY</a></li>
                        <li><a href="HomeCategory.jsp?category=ACCESSORIES">ACCESSORIES</a></li>
                        <li><a href="HomeCategory.jsp?category=OTHERS">OTHERS</a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </nav>
        </div>
